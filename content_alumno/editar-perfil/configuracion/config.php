        ...
        <div id="page-wrapper">
            ...
            <div class="tabbable">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#general" data-toggle="tab" role="tab">Privacidad</a>
                    </li>
                ...
                <div class="tab-pane fade" id="general">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <img src="../../../img/cv/calificaciones.png"  class="img-responsive imagenes" alt="Responsive image"  style="margin-left:90px;">
                            <input type="checkbox" style="margin-left: 70px;"> Privado
                            <h4 class="nombre-icono">Datos escolares</h4>
                            <a href="../datos/editar-datose.jsp">
                                <button type="button" class="btn btn-primary btn-xs boton-icono">Editar</button>
                            </a>
                        </div>
                        <div class="col-md-4">
