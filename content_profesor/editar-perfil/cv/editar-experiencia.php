...
<?php 
    define("TITLE","Editar experiencia");
                    ...
                    <form role="form" id="Distinciones" name="Distinciones">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="nombramiento" name="nombramiento" class="form-control">
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label> Líneas de Investigación/Trabajo: </label>
                                <br>
                            <textarea id="lineas" class="lineas" rows="6" cols="70"></textarea>
                            </div>  

                            <div class="form-group">
                                <label> Principales Logros: </label>
                                <br>
                            <textarea id="logros" class="logros" rows="8" cols="70"></textarea>
                            </div>
