...
<?php 
    define("TITLE","Editar distinciones");
                    ...
                    <form role="form" id="Distinciones" name="Distinciones">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label> Título de la distinción: </label>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control jsrequired" id="institución" name="institucion">
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label> Otorgante:</label><input id="otorgante" name="otorgante" input class="form-control">
                            </div>

                            <div class="form-group">
                                <label> Descripción de la distinción: </label>
