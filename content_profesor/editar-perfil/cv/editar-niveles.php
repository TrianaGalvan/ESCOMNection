                    ...
                    <form role="form" id="Distinciones" name="Distinciones">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label> Nivel/Grado académico: </label>
                                <input id="Titulo" name="Titulo" class="form-control jsrequired">
                            </div>
                            
                            <div class="form-group">
                                <label> Número de cédula profesional:</label>
                                <input id="otorgante" name="otorgante" input class="form-control jsrequired">
                            </div>

                            <div class="form-group">
                                <label> Título del nivel/grado: </label>
                     		<input id="revista" name="revista" class="form-control jsrequired">           
                            </div>
                            
                            <div class="form-group">
                                <label> Estatus: </label>
                     		<input id="volumen" name="volumen" class="form-control">           
                            </div>
                            
                            <div class="form-group">
                                <label> Título de tésis: </label>
                                <input class="form-control jsrequired" id="noautores" name="noautores">
                            </div>
                            ...
                            <div class="form-group">
                                <label> Estado: </label>
                                <input class="form-control" id="noautores" name="noautores">
                            </div>
