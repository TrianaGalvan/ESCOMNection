        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/content_administrador/perfil.php">Bienvenid&#64; <?php echo USERNAME;?></a>
                </div>
                <!-- Top Menu Items -->
                ...
                <ul class="nav navbar-right top-nav" style="overflow:scroll visible;">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Ruby Ramírez <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="/content_administrador/editar-perfil/configuracion/config.php"><i class="fa fa-fw fa-gear"></i> Configuración</a>
                            </li>
                            <li class="divider"></li>
                            <li>
                ...
                <div class="collapse navbar-collapse navbar-responsive-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li class="active">
                            <a href="/content_administrador/alumnos.php"><i class="fa fa-graduation-cap"></i> Alumnos</a>
                        </li>
                        
                         <li>
                             <a href="/content_administrador/profesores.php"><i class="fa fa-university"></i> Profesor</a>
                            
                        </li>
                        <li>
                             <a href="  /content_administrador/empresas.php"><i class="fa fa-users"></i> Empresas</a>
